...
<template>
  <div class="bg-stone-50 dark:bg-stone-900 hidden border-b border-stone-200 dark:border-stone-700 shrink-0 flex items-center">
    <button
      v-for="tab in tabs"
      :key="tab.key"
      class="px-4 py-2 text-xs font-semibold uppercase tracking-wider border-b-2 cursor-pointer"
      :class="activeTab === tab.key
        ? 'border-blue-600 dark:border-blue-500 text-stone-700 dark:text-stone-200'
